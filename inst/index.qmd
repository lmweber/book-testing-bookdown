...
intro <- tryCatch(
    {
        description <- packageDescription("BookTestingBiocBook")
...
👉 [ghcr.io/lmweber/booktestingbiocbook](https://ghcr.io/lmweber/booktestingbiocbook) 🐳
...
#| eval: false
docker run -it ghcr.io/lmweber/booktestingbiocbook:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/lmweber/booktestingbiocbook:devel
```
...
#| eval: false
docker run -it ghcr.io/lmweber/booktestingbiocbook:devel bash
